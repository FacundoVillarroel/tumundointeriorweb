    ...
    <div ref={conventionsRef} className={`conventionsContainer , ${className}`}>
      ...
      <div className="conventionsDescriptionContainer">
        ...
        <div className="itemContainer">
          ...
          <p>
            <span className="dosisBold">$USD 40,00</span> pago a través de
            PayPal, más comisión{" "}
            <span className="dosisBold">(pago internacional).</span>
          </p>
        </div>
        <div className="itemContainer">
          <FaHourglassHalf fontSize={25} color={"a38f85"} />
          <p>
            La duración de cada sesión psicoterapéutica va desde los{" "}
            <span className="dosisBold">50 a 60 minutos.</span>
          </p>
        </div>
        <div className="itemContainer">
          <FaHeartbeat fontSize={25} color={"a38f85"} />
          <p>
            <span className="dosisBold">Convenios</span> con todas las{" "}
            <span className="dosisBold">Isapres</span> del país y{" "}
            <span className="dosisBold">seguros de salud</span> complementarios.
          </p>
        </div>
        <div className="isapresContainer">
          <a
            href="http://www.consalud.cl/"
            target={"_blank"}
            rel={"noreferrer"}
          >
