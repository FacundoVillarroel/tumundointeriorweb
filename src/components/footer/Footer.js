    ...
    <div className="footerContainer">
      <div className="footerTextContainer">
        <h4 className="footerText">
          Para mayor información y/o consulta, no dudes en contactarnos.
        </h4>
        <div>
          <div
            className="footerButtonContainer openContactBtn2"
            onClick={() => toggleSidebar("contacto")}
          >
            <h4 className="footerButtonText">Enviar un mensaje</h4>
          </div>
          <div
            className="footerButtonContainer openConventionsBtn"
            onClick={() => openConventions()}
          >
