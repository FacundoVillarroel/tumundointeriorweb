...
const Article4 = ({handleClick, className}) => {
  return (
    <div className={`articleTextContainer article4 ${className}`}>
      ...
      <div className='parragraph'>
        <p>Para contextualizar, hay que tener claro lo que se entenderá por somatización. Para la psicología, como estudio de la salud mental, <span className='dosisBold'>la somatización hace referencia a la expresión de malestar emocional manifestado a través de síntomas físicos, NO explicados por ninguna enfermedad biológica que los valide.</span></p>
      ...
      <div className='parragraph'>
        <p>Por otra parte, es importante y resulta muy necesario profundizar en la temática de somatización, sobre todo al momento de abordarla frente a un paciente, ya que se debe contar con una base teórica sólida que respalde la intervención psicológica. Esto dado a que como la manifestación de la sintomatología, al ser corporal y desde una expresión que se relaciona más cercanamente al ámbito médico, resulta complejo que las personas asocien y validen que lo que les está ocurriendo es producto de un <span className='dosisBold'>conflicto intrapsíquico</span>, sobre todo porque al tratarse de un conflicto que presenta la persona en niveles inconscientes, donde la mente se encuentra disociando contenidos amenazantes para la conciencia de la persona, la experiencia que percibe de lo que le ocurre es extraña. Solamente cuando los exámenes médicos comienzan a descartar que no hay un diagnóstico biológico, los pacientes recién dan indicios de comenzar a abrirse a la posibilidad de que lo que les ocurre es algo correspondiente al ámbito de la psicología.</p>
      </div>
      <div className='parragraph'>
        <p>La mente es muy compleja, y por más que suele asociarse a algo exclusivamente cognitivo, es más que esto. Recordando los análisis y visión teórica que tenía W. James (1890), en su libro: <span className='dosisBold'>“Principios de psicología”</span>, postulaba que la mente era considerada como un todo en el ser humano, es decir, el cuerpo (soma), era entendido como una parte de la mente, por lo que a través de su propio lenguaje, como lo realiza mediante los síntomas, <span className='dosisBold'>“el cuerpo habla”</span>, pero en sus propios códigos y simbolismos que necesitan ser descifrados, ya que entrega una información muy valiosa al terapeuta para ir más allá y comprender en mayor profundidad la problemática que se encuentra presentando el paciente. Por lo mismo, se considera que aplicar únicamente técnicas psicológicas centradas exclusivamente en la eliminación del síntoma, por más que resulten eficaces bajo el criterio de que no se encuentre presente, queda en algún nivel no comprendido lo que le pasa a la persona, habiendo una alta probabilidad de que el síntoma pueda manifestarse en el futuro de la misma forma o de otra, ya que el conflicto sigue existiendo en el sujeto en algún lugar de su psiquis.</p>
      </div>
      <div className='parragraph'>
